...
export const SERVICES: ServiceData[] = [
  ...
  },
  {
    ...
    title: "Buy to Let",
    description:
      "Investment property mortgages with competitive rates for landlords and investors",
    icon: "🏢",
    image: image4,
  ...
  },
  {
    ...
    title: "New Build",
    description:
      "Specialist mortgages for new build properties with developer incentives",
    icon: "🏗️",
    image: image5,
  ...
  },
  {
    ...
    title: "Help to Buy",
    description:
      "Government schemes to help you buy your first home with a smaller deposit",
    icon: "🤝",
    image: image6,
  ...
  },
  {
    ...
    description:
      "Short-term financing solutions to bridge the gap between property transactions",
    icon: "🌉",
    image: bridgeimage,
...
export const PRODUCTS: ProductData[] = [
  {
    ...
    description:
      "Standard residential mortgages for home purchases and remortgaging",
    rate: "4.65%",
  ...
  },
  {
    ...
    description:
      "Specialist mortgages and government schemes for first-time buyers",
    rate: "4.89%",
  ...
  },
  {
    ...
    description:
      "Specialist financing for property investors with competitive rates and flexible terms",
    rate: "5.25%",
  ...
  },
  {
    ...
    description:
      "Flexible mortgage solutions for contractors, freelancers, and business owners",
    rate: "4.95%",
...
export const NAVIGATION: NavigationData[] = [
  ...
  },
  {
    ...
    dropdownItems: [
      ...
      {
        label: "Home, Buildings & Contents Insurance",
...
export const INSURANCE_PRODUCTS: InsuranceData[] = [
  {
    ...
    longDescription:
      "Protect what matters most. Life insurance provides peace of mind that your loved ones will be financially secure if the unexpected happens. Whether you’re looking to cover a mortgage, provide for your family, or leave a legacy, there’s a policy to suit your needs.",
    keyBenefits: [
  ...
  },
  {
    ...
    longDescription:
      "If you couldn’t work due to illness or injury, how would you cover your monthly bills? Income protection pays you a regular income if you’re unable to work, helping you stay on top of your finances while you recover. It’s peace of mind that your lifestyle and commitments are covered—no matter what life throws your way.",
    keyBenefits: [
  ...
  },
  {
    ...
    longDescription:
      "A serious illness can impact more than just your health—it can affect your income, lifestyle, and family’s future. Critical illness cover provides a tax-free lump sum if you’re diagnosed with a major condition like cancer, heart attack, or stroke. It’s designed to ease financial pressure so you can focus on recovery.",
    keyBenefits: [
  ...
  },
  {
    ...
    title: "Accident, Sickness & Unemployment (ASU)",
    description:
      "Short-term cover for mortgage payments during unemployment or illness",
    longDescription:
      "Worried about losing your income due to unexpected illness, injury, or redundancy? ASU cover provides short-term monthly payments to help cover your mortgage or essential bills if you're unable to work. It’s a flexible safety net designed to give you breathing room during life’s tougher moments.",
    keyBenefits: [
  ...
  },
  {
    ...
    longDescription:
      "Protect your home and everything in it. Buildings insurance covers the structure of your property, while contents insurance protects your belongings from risks like fire, theft, or damage. Whether you are a homeowner or landlord, having the right cover in place can save you thousands in the event of the unexpected.",
    keyBenefits: [
...
export const getMainServices = (): ServiceData[] => {
  return SERVICES.filter((service) => service.category === "main").sort(
    (a, b) => a.order - b.order
  );
};

export const getAdditionalServices = (): ServiceData[] => {
  return SERVICES.filter((service) => service.category === "additional").sort(
    (a, b) => a.order - b.order
  );
};
