...
// import { getMainServices, getAdditionalServices, getFeaturedInsurance } from '../data';
...
//   const featuredInsurance = getFeaturedInsurance();
...
//               {featuredInsurance.map((insurance) => (
