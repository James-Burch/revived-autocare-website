  ...
  return (
    <Layout title="Noble Mortgages">
      <div className="home-page">
        ...
        {/* Mortgage Services Section - Tiffany Blue Background */}
        ...
        {/* Lenders Section - White Background */}
        ...
        {/* Protection Section - Light Tiffany Blue Background */}
        ...
        {/* Lazy load FAQ section - White Background */}
        <Suspense
          fallback={
        ...
        {/* Reviews Section - Light Tiffany Blue Background */}
        ...
        {/* CTA Section - Tiffany Blue Gradient Background */}
        <section className="cta-professional-tiffany">
          <div className="container">
