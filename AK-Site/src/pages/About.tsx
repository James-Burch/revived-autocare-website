  ...
  return (
    ...
    >
      <div className="about-page">
          ...
          <div className="container">
            <div className="about-hero-content">
              <div className="about-hero-text">
                <h1>
                  About <span className="hero-accent">Noble</span> Mortgages
                </h1>
                <p className="about-hero-description">
                  Your trusted mortgage advisors, committed to finding you the
                  perfect mortgage solution with expert guidance and
        ...
        {/* Our Story Section - Bright Teal Background */}
          ...
          <div className="container">
            <div className="our-story-content">
              <div className="story-text">
                <h2>Our Story</h2>
                <p>
                  Noble Mortgages was founded with a simple mission: to make the
                  mortgage process straightforward, transparent, and stress-free
                  for every client. We understand that buying a home or
                  remortgaging is one of life's biggest financial decisions, and
                  we're here to guide you every step of the way.
                </p>
                <p>
                  Our team of qualified mortgage advisors brings years of
                  combined experience in the UK mortgage market. We pride
                  ourselves on our personalized approach, taking the time to
                  understand your unique circumstances and finding solutions
                  that work for you.
                </p>
              </div>
              <div className="story-highlights">
                ...
                <div className="highlight-card">
                  ...
                  <p>
                    Completely independent advice with no bias towards any
                    lender
                  </p>
                </div>
              </div>
        ...
        <section className="why-choose-section">
          <div className="container">
            <div className="section-header-professional">
              ...
              <p>
                We go above and beyond to ensure you get the best possible
                mortgage deal
              </p>
            </div>
            ...
            <div className="benefits-grid-large">
              <div className="benefit-card">
                ...
                <p>
                  Our comprehensive mortgage advice service is completely free
                  to you. We're paid by the lender once your mortgage completes.
                </p>
              </div>
              <div className="benefit-card">
                <div className="benefit-icon">⚡</div>
              ...
              <div className="benefit-card">
                ...
                <p>
                  You'll have a dedicated advisor throughout your journey,
                  ensuring consistent, personalized support.
                </p>
              </div>
              <div className="benefit-card">
                <div className="benefit-icon">📋</div>
                ...
                <p>
                  From initial consultation to completion, we handle all the
                  paperwork and liaise with all parties involved.
                </p>
              </div>
              <div className="benefit-card">
        ...
        {/* Our Values Section - Bright Teal Background */}
          ...
          <div className="container">
            <div className="values-content">
              <div className="values-text">
                ...
                >
                  These principles guide everything we do, ensuring you receive
                  the highest standard of service and advice.
                </p>
                <div className="value-item">
                  <h3>Transparency</h3>
                  <p>
                    Complete transparency in all our dealings. No hidden fees,
                    no surprises, just honest advice you can trust.
                  </p>
                </div>
                <div className="value-item">
                  <h3>Expertise</h3>
                  <p>
                    Our team stays up-to-date with market changes and
                    regulations to provide you with the most current advice.
                  </p>
                </div>
                <div className="value-item">
                  <h3>Client-First</h3>
        ...
        {/* Accreditations Section - Dark Background */}
          ...
          <div className="container">
            ...
            <div className="accreditations-grid">
              ...
              <div className="accreditation-item">
                ...
                <p>
                  Our advisors hold Certificate in Mortgage Advice & Practice
                </p>
              </div>
              <div className="accreditation-item">
                ...
                <p>
                  Your funds are protected by the Financial Services
                  Compensation Scheme
                </p>
              </div>
            </div>
