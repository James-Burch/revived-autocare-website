...
const Logo: React.FC<LogoProps> = ({ 
  ...
  // SVG Logo with professional mortgage theme - Optimized for dark header
  const renderSVGLogo = () => {
    const isWhite = variant === 'white';
    // Use white colors for dark header
    const primaryColor = isWhite ? '#FFFFFF' : '#FFFFFF';
    const accentColor = isWhite ? '#0ABAB5' : '#0ABAB5';
