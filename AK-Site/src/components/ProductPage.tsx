...
//                                         <div className="fact">
//                                             <span className="fact-label">Lenders:</span>
//                                             <span className="fact-value">90+ nationwide</span>
//                                         </div>
//                                         <div className="fact">
//                                             <span className="fact-label">Advice:</span>
//                                             <span className="fact-value">Completely free</span>
//                                         </div>
//                                         <div className="fact">
//                                             <span className="fact-label">Regulation:</span>
//                                             <span className="fact-value">FCA authorized</span>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
